...
export function RelatorioFaixaEtaria({ navigation, route }) {
  const { lojaId, lojaNome, lojaImagem, printUrl, mensagensQuantidade } = route.params;
        ...
        >
          <View style={{ flexDirection: "row", marginHorizontal: 12 }}>
            ...
            >
              <TouchableOpacity
                onPress={() => {
                  navigation.navigate("RelatorioFaixaEtariaShare", {
                    lojaId: lojaId,
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("EnviarMensagem", {
                        lojaId: lojaId,
                        tokenCelular: tokenCelular18a24anos,
                      })
                    }
                  >
                    <Image
                ...
                {mensagensQuantidade > 0 && (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("EnviarMensagem", {
                        lojaId: lojaId,
                        tokenCelular: tokenCelular25a34anos,
                      })
                    }
                  >
                    <Image
                ...
                {mensagensQuantidade > 0 && (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("EnviarMensagem", {
                        lojaId: lojaId,
                        tokenCelular: tokenCelular35a44anos,
                      })
                    }
                  >
                    <Image
                ...
                {mensagensQuantidade > 0 && (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("EnviarMensagem", {
                        lojaId: lojaId,
                        tokenCelular: tokenCelular45a54anos,
                      })
                    }
                  >
                    <Image
                ...
                {mensagensQuantidade > 0 && (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("EnviarMensagem", {
                        lojaId: lojaId,
                        tokenCelular: tokenCelular55a64anos,
                      })
                    }
                  >
                    <Image
                ...
                {mensagensQuantidade > 0 && (
                  <TouchableOpacity
                    onPress={() =>
                      navigation.navigate("EnviarMensagem", {
                        lojaId: lojaId,
                        tokenCelular: tokenCelular65mais,
                      })
                    }
                  >
                    <Image
